...
public:
	...
	//Draw book case
	void drawBookCase();
	//Draw the sword object
	void drawSword();
	//Draw the candle object
	void drawCandle();
	//Draw the wall and floor
	void drawWallFloor();

	//draw box
	void drawBox(glm::vec3 scale,
		float Xrotation,
		float Yrotation,
		float Zrotation,
		glm::vec3 position,
	...
	//draw cylinder
	void drawCylinder(glm::vec3 scale,
		float Xrotation,
		float Yrotation,
		float Zrotation,
		glm::vec3 position,
	...
	void drawPrism(glm::vec3 scale,
		...
		std::string material);
	//draw sphere
	void drawSphere(glm::vec3 scale,
		float Xrotation,
		float Yrotation,
		float Zrotation,
		glm::vec3 position,
